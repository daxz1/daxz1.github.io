        ...
        <div className="grid__container">
          <main className="content">
            ...
            <p className="text__align--center">
              ...
              <a
                href="https://www.prodyna.com/en/"
                target="_blank"
                rel="noopener noreferrer"
                className="text__link--no-styles"
              >
                <strong>@prodyna</strong>
              </a>{" "}
              London office.
            </p>
      ...
      <section className="flex__container">
        <div className="grid__container--full">
          <div className="content section__projects">
            <div className="powwownow">Powwownow</div>
            <div className="fn">Financial News</div>
          </div>
        </div>
      </section>
    </>
